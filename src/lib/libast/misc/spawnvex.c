...
static pid_t spawn(const char *path, int nmap, const int map[], const struct inheritance *inherit,
...
static pid_t spawnve(int mode, const char *path, char *const argv[], char *const envv[]) {
    pid_t pid;
    int i;
    int n;
    int m;
